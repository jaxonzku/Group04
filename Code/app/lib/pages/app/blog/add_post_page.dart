...
import 'package:college_App/secure_string.dart';
...
class _AddPostPageState extends State<AddPostPage> {
  ...
  _post() async {
    ...
    DocumentReference postReference =
        firestore.collection(appname + '-post').document();
    ...
    DocumentReference useUpdateReference =
        firestore.collection(appname).document(appState.firebaseUser.uid);
