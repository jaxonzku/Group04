...
import 'package:college_App/pages/app/profile/background_image_with_circular_avatar.dart';
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: Hero(
                tag: 'profile-pic',
                child:
                    BackgroundImageWithCircularAvatar(appState.user.photoUrl),
              ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: const EdgeInsets.only(
          top: _topPadding, right: _rightPadding, left: _leftPadding),
      child: Row(
