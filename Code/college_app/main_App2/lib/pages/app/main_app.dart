import 'dart:async';
import 'package:college_App/pages/app/notifications/all_users_screen.dart';
import 'package:college_App/pages/app/notifications/chatmain.dart';
import 'package:flutter/material.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:college_App/StylesAndColors.dart';
import 'package:college_App/pages/app/clubs/clubs_page.dart';
import 'package:college_App/pages/app/profile/profile_page.dart';
import 'package:college_App/methods.dart' as methods;
import 'package:college_App/navigarion_drawer.dart';
import 'package:college_App/pages/app/app_state.dart';
import 'package:college_App/pages/app/blog/blog_page.dart';
import 'package:college_App/pages/app/home/home_page.dart';
import 'package:college_App/pages/app/library/library_page.dart';
import 'package:college_App/pages/app/notifications/chatmain.dart';
...
class _MainAppState extends State<MainApp> {
  ...
  AllUsersScreen notificationsPage;
  ...
  void _initializePages() {
    ...
    notificationsPage =
        AllUsersScreen(openDrawerFunction: () => _openNavDrawer());
    pages = [
      homePage,
      blogPage,
      clubsPage,
...
//        selectNotification: onSelectNotification);
  ...
  _showFlutterLocalNotifications(
    ...
    var androidPlatformChannelSpecifics = new AndroidNotificationDetails(
        'my_nit_id', 'college_App', 'MyNiT app for Nit-A.P students',
