import 'package:college_App/pages/app/notifications/models/user_details.dart';
...
import 'package:college_App/pages/app/notifications/home_page.dart';
...
//    _showDailyNotifications();
  ...
  void addDataToDb(FirebaseUser user, fullName) {
    _userDetails.name = fullName;
    ...
    _documentReference = Firestore.instance.collection(chatusers).document(uid);
  ...
  _submit() async {
    if (_formKey.currentState.validate()) {
      ...
      if (snapshot.value != null) {
        ...
        handleError('Snapshot is null!,check');
      }
    }
  }
  ...
  void _createUser(String email, String password, String rollNo) async {
    ...
    print(user.toString());
    if (user != null) {
      _createUserInDatabase(rollNo, email, user);
    } else {
  ...
  void _createUserInDatabase(String rollNo, String email, user) async {
    ...
    addDataToDb(user, _fullName);
    final data = student.toMap();
    print(data);
    print(
        "herewwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwerrrrrrrrrrrrrrrrrrrrrrrr");
    Firestore.instance
